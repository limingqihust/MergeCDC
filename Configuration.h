...
class Configuration {
 ...
 public:
  ...
  Configuration() {
    ...
    strcpy(inputPath, "/root/wordcount-exp3/MergeCDC/Input/tera1G");
    strcpy(outputPath, "/root/wordcount-exp3/MergeCDC/Output/tera1G");
    strcpy(partitionPath, "/root/wordcount-exp3/MergeCDC/Partition/tera1G");
    // numSamples = 10000;
    numSamples = 10000000;
  }
  ~Configuration() {}
