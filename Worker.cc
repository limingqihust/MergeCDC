 ...
 */
void Worker::updateInputPartitionCollection4WordCount() {
...
void Worker::updateLineList4WordCount(const std::unordered_map<std::string, int>& word_count, LineList* lineList) {
